                ...
                <tbody className="table-body">
                    {bookings.map((booking, index) => (
                        <tr key={index}>
                            ...
                            <td>
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" onClick={() => handleOpenModal(booking)}>
